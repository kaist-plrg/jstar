package kr.ac.kaist.jstar.extractor

import kr.ac.kaist.jstar.ir.IRParser
import kr.ac.kaist.jstar.extractor.algorithm.{ AlgoParser, HeadParser }
import kr.ac.kaist.jstar.extractor.grammar.GrammarParser
